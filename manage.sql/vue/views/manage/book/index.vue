<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="categoryId">
        <el-input
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="categoryId" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="bookRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="categoryId">
          <el-input v-model="form.categoryId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="修改时间" prop="dateTime">
          <el-date-picker clearable
